...
jest.mock('@organisms/DisasterMap', () => ({
...
jest.mock('@organisms/FilterTabs', () => ({
...
jest.mock('@templates/MapTemplate', () => ({
...
jest.mock('@organisms/ResponderProfileMenu', () => ({
